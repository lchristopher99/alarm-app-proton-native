...
var StyledText = function (_Component) {
  ...
  _createClass(StyledText, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_Area.HasAreaParentContext.Consumer, null, function (hasParent) {
        if (!hasParent) {
          return _react2.default.createElement(_.Area, null, _react2.default.createElement(_.Area.Text, otherProps, children));
        } else {
          return _react2.default.createElement(_.Area.Text, otherProps, children);
        }
      });
    }
  }]);
