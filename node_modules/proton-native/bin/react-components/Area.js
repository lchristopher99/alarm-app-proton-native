  ...
  _createClass(Area, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          groupProps = _objectWithoutProperties(_props, ['children', 'stretchy', 'label', 'column', 'row', 'span', 'expand', 'align', 'onMouseMove', 'onMouseUp', 'onMouseDown', 'onMouseEnter', 'onMouseLeave', 'onKeyUp', 'onKeyDown']);
