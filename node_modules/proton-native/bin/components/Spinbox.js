...
var Spinbox = function (_DesktopComponent) {
  ...
  _createClass(Spinbox, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiSpinbox();
    }
  }, {
    key: 'render',
...
Spinbox.propTypes = _extends({}, _DesktopComponent2.universalPropTypes, {
...
Spinbox.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true,
  value: 0,
