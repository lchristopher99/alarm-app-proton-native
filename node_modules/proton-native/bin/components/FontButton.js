...
var FontButton = function (_DesktopComponent) {
  ...
  function FontButton(root, props) {
    ...
    _this.eventParameter = {
      onChanged: function onChanged() {
        var f = _this.element.getFont();
        var italic = f.getItalic();
        return {
          fontFamily: f.getFamily(),
          fontSize: f.getSize(),
          fontWeight: f.getWeight(),
          fontStyle: Object.keys(_libuiNode2.default.textItalic).find(function (v) {
            return _libuiNode2.default.textItalic[v] === italic;
          }),
  ...
  _createClass(FontButton, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiFontButton();
    }
  }, {
    key: 'render',
...
FontButton.propTypes = _extends({}, _DesktopComponent2.universalPropTypes, {
  onChange: _propTypes2.default.func
});

FontButton.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
