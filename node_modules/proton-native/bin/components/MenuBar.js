...
var MenuBar = function (_DesktopComponent) {
  ...
  _createClass(MenuBar, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiMenu(this.props.label);
    }
  }, {
    key: 'render',
...
MenuBar.propTypes = _extends({}, _DesktopComponent3.universalPropTypes, {
  label: _propTypes2.default.string
});

MenuBar.defaultProps = _extends({}, _DesktopComponent3.universalDefaultProps, {
  label: ''
});
...
MenuBar.Item.propTypes = _extends({
  ...
  type: _propTypes2.default.oneOf([_types.CHECK, _types.QUIT, _types.ABOUT, _types.PREFERENCES, _types.SEPARATOR, _types.ITEM]),
