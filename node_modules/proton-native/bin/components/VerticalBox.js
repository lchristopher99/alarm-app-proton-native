...
var VerticalBox = function (_DesktopComponent) {
  ...
  function VerticalBox(root, props) {
    ...
    var _this = _possibleConstructorReturn(this, (VerticalBox.__proto__ || Object.getPrototypeOf(VerticalBox)).call(this, root, props));
...
VerticalBox.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true,
  padded: false
});
