...
var RadioButton = function (_DesktopComponent) {
  _inherits(RadioButton, _DesktopComponent);

  function RadioButton(root, props) {
    _classCallCheck(this, RadioButton);

    var _this = _possibleConstructorReturn(this, (RadioButton.__proto__ || Object.getPrototypeOf(RadioButton)).call(this, root, props));
  ...
  _createClass(RadioButton, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiRadioButtons();
    }
  }, {
    key: 'render',
...
RadioButton.propTypes = _extends({}, _DesktopComponent3.universalPropTypes, {
...
RadioButton.defaultProps = _extends({}, _DesktopComponent3.universalDefaultProps, {
  enabled: true,
  visible: true,
  selected: -1,
