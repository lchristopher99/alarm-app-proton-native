...
var Button = function (_DesktopComponent) {
  ...
  _createClass(Button, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiButton();
    }
  }, {
    key: 'render',
...
Button.propTypes = _extends({}, _DesktopComponent2.universalPropTypes, {
...
Button.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true,
