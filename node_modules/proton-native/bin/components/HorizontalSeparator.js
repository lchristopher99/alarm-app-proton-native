...
var HorizontalSeparator = function (_DesktopComponent) {
  ...
  _createClass(HorizontalSeparator, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiHorizontalSeparator();
    }
  }, {
    key: 'render',
...
HorizontalSeparator.propTypes = _extends({}, _DesktopComponent2.universalPropTypes, {
  enabled: _propTypes2.default.bool,
  visible: _propTypes2.default.bool
});

HorizontalSeparator.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true
});
