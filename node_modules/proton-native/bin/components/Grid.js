...
var Grid = function (_DesktopComponent) {
  _inherits(Grid, _DesktopComponent);

  function Grid(root, props) {
    _classCallCheck(this, Grid);

    var _this = _possibleConstructorReturn(this, (Grid.__proto__ || Object.getPrototypeOf(Grid)).call(this, root, props));
  ...
  _createClass(Grid, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiGrid();
    }
  }, {
    key: 'render',
...
Grid.propTypes = _extends({}, _DesktopComponent2.universalPropTypes, {
  enabled: _propTypes2.default.bool,
  visible: _propTypes2.default.bool,
  padded: _propTypes2.default.bool
});

Grid.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true,
  padded: false
});
