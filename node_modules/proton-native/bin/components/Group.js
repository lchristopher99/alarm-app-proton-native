...
var Group = function (_DesktopComponent) {
  _inherits(Group, _DesktopComponent);

  function Group(root, props) {
    _classCallCheck(this, Group);

    var _this = _possibleConstructorReturn(this, (Group.__proto__ || Object.getPrototypeOf(Group)).call(this, root, props));
  ...
  _createClass(Group, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiGroup();
    }
  }, {
    key: 'render',
...
Group.propTypes = _extends({}, _DesktopComponent2.universalPropTypes, {
...
Group.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true,
  margined: false,
  title: ''
