...
var Text = function (_DesktopComponent) {
  _inherits(Text, _DesktopComponent);
  ...
  _createClass(Text, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiLabel();
    }
  }, {
    key: 'render',
...
Text.propTypes = _extends({}, _DesktopComponent2.universalPropTypes, {
  enabled: _propTypes2.default.bool,
  visible: _propTypes2.default.bool,
  children: _propTypes2.default.string
});

Text.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true,
  children: ''
});
