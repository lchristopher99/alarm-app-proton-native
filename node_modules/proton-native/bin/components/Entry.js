...
var Entry = function (_DesktopComponent) {
  ...
  _createClass(Entry, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiEntry();
    }
  }, {
    key: 'render',
...
Entry.propTypes = _extends({}, _DesktopComponent2.universalPropTypes, {
...
Entry.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true,
  readOnly: false,
