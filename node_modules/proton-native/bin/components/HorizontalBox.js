...
var HorizontalBox = function (_DesktopComponent) {
  ...
  function HorizontalBox(root, props) {
    ...
    var _this = _possibleConstructorReturn(this, (HorizontalBox.__proto__ || Object.getPrototypeOf(HorizontalBox)).call(this, root, props));
  ...
  _createClass(HorizontalBox, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiHorizontalBox();
    }
  }, {
    key: 'render',
...
HorizontalBox.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true,
  padded: false
});
