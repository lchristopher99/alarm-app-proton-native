...
var EditableCombobox = function (_DesktopComponent) {
  ...
  _createClass(EditableCombobox, [{
    ...
    value: function newElement() {
      this.element = new _libuiNode2.default.UiEditableCombobox();
    }
  }, {
    key: 'render',
...
EditableCombobox.propTypes = _extends({}, _DesktopComponent3.universalPropTypes, {
...
EditableCombobox.defaultProps = _extends({}, _DesktopComponent3.universalDefaultProps, {
  enabled: true,
  visible: true,
  text: '',
