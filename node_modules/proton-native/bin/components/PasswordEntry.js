...
var PasswordEntry = function (_DesktopComponent) {
  _inherits(PasswordEntry, _DesktopComponent);

  function PasswordEntry(root, props) {
    _classCallCheck(this, PasswordEntry);
  ...
  _createClass(PasswordEntry, [{
    key: 'newElement',
    value: function newElement() {
      this.element = new _libuiNode2.default.UiPasswordEntry();
    }
  }, {
    key: 'render',
...
PasswordEntry.propTypes = _extends({}, _DesktopComponent2.universalPropTypes, {
...
PasswordEntry.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true,
  readOnly: false,
