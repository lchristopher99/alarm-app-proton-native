...
var MultilineEntry = function (_DesktopComponent) {
  _inherits(MultilineEntry, _DesktopComponent);

  function MultilineEntry(root, props) {
    _classCallCheck(this, MultilineEntry);
  ...
  _createClass(MultilineEntry, [{
    key: 'newElement',
    value: function newElement() {
      this.element = new _libuiNode2.default.UiMultilineEntry();
    }
  }, {
    key: 'render',
...
MultilineEntry.propTypes = _extends({}, _DesktopComponent2.universalPropTypes, {
...
MultilineEntry.defaultProps = _extends({}, _DesktopComponent2.universalDefaultProps, {
  enabled: true,
  visible: true,
  readOnly: false,
...
exports.default = MultilineEntry;