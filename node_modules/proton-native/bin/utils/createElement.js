...
function createElement(type, props) {
  var COMPONENTS = {
    ...
    AREA: function AREA() {
      return new _components.Area(_render.ROOT_NODE, props);
    },
    AREARECTANGLE: function AREARECTANGLE() {
      return new _components.Area.Rectangle(_render.ROOT_NODE, props);
    },
    AREALINE: function AREALINE() {
      return new _components.Area.Line(_render.ROOT_NODE, props);
    },
    AREAARC: function AREAARC() {
      return new _components.Area.Arc(_render.ROOT_NODE, props);
    },
    AREABEZIER: function AREABEZIER() {
      return new _components.Area.Bezier(_render.ROOT_NODE, props);
    },
    AREAPATH: function AREAPATH() {
      return new _components.Area.Path(_render.ROOT_NODE, props);
    },
    AREAGROUP: function AREAGROUP() {
      return new _components.Area.Group(_render.ROOT_NODE, props);
    },
    AREACIRCLE: function AREACIRCLE() {
      return new _components.Area.Circle(_render.ROOT_NODE, props);
    },
    AREATEXT: function AREATEXT() {
      return new _components.Area.Text(_render.ROOT_NODE, props);
    },
    default: undefined
  };
